...
define('FLIPBOOK_VIEWER_VERSION', '1.0.1');
...
function flipbook_viewer_shortcode($atts): string
{
    ...
    ob_start();
    ?>
    <div class="flipbook-viewer" id="<?php echo esc_attr($instance_id); ?>" data-images="<?php echo esc_attr(wp_json_encode($images)); ?>" data-pdf="<?php echo esc_url($pdf); ?>">
